...
```
  ...
  In order to understand be able to understand how much money you saved by gardening, we will need the following variables: price of seeds(including tax), number of seeds planted by vegetable and variety, labor cost, harvest weight by vegetable and variety, cost of the vegetable and variety in the grocery store by weight. Unfortunately, we do not have a variable for the labor cost included in our datasets. 
  
  We would use the garden_harvest dataset and use a 
